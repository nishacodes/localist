...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { city: @map.city, lat: @map.lat, long: @map.long, state: @map.state, user_id: @map.user_id }
    end
  ...
  test "should update map" do
    put :update, id: @map, map: { city: @map.city, lat: @map.lat, long: @map.long, state: @map.state, user_id: @map.user_id }
    assert_redirected_to map_path(assigns(:map))
  end
